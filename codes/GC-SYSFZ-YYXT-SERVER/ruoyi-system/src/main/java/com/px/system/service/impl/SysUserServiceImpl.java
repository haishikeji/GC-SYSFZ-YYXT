...
import com.px.common.constant.CacheNames;
...
import com.px.common.core.service.UserService;
import com.px.common.exception.ServiceException;
import com.px.common.helper.DataBaseHelper;
import com.px.common.helper.LoginHelper;
import com.px.common.utils.StreamUtils;
...
public class SysUserServiceImpl implements ISysUserService, UserService {
    ...
    @Override
    public List<SysUser> getUserInfoList(String name) {
        String nameStr = "";
        if (name != null && !"".equals(name.trim()) && !"null".equals(name.toString())){
            nameStr = name;
        }
        nameStr = "%"+nameStr+"%";
        return baseMapper.getUserInfoList(nameStr);
    }
